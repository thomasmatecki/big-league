...
export const ProfileApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveProfile(
        options
      );
 ...
 * @export
 */
export const RestApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    destroyLeague: async (
      ...
      const localVarPath = `/rest/leagues/{id}/`.replace(
        `{${"id"}}`,
    ...
    destroyPlayer: async (
      ...
      const localVarPath = `/rest/players/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    destroySeason: async (
      ...
      const localVarPath = `/rest/seasons/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    destroyTeam: async (
      ...
      const localVarPath = `/rest/teams/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    retrieveUser: async (
      ...
      const localVarPath = `/rest/users/{id}/`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const RestApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createLeague(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<League>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createLeague(
        league,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createPlayer(
        player,
        options
      );
      return createRequestFunction(
    ...
    async createSeason(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Season>
    > {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.destroyLeague(
        id,
        options
      );
      return createRequestFunction(
    ...
    async destroyPlayer(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.destroyPlayer(
        id,
        options
      );
      return createRequestFunction(
    ...
    async destroySeason(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.destroySeason(
        id,
        options
      );
      return createRequestFunction(
    ...
    async destroyTeam(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.destroyTeam(
        id,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listLeagues(
        page,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listSeasons(
        page,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.partialUpdateLeague(
          id,
          league,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.partialUpdatePlayer(
          id,
          player,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.partialUpdateSeason(
          id,
          season,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.partialUpdateTeam(id, team, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async retrieveLeague(
      id: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<League>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveLeague(
        id,
        options
      );
      return createRequestFunction(
    ...
    async retrievePlayer(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Player>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrievePlayer(
        id,
        options
      );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async retrieveSeason(
      id: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Season>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveSeason(
        id,
        options
      );
      return createRequestFunction(
    ...
    async retrieveTeam(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Team>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveTeam(
        id,
        options
      );
      return createRequestFunction(
    ...
    async updateLeague(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<League>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateLeague(
        id,
        league,
        options
      );
    ...
    async updateSeason(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Season>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateSeason(
        id,
        season,
        options
      );
 ...
 * @export
 */
export const RestApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    partialUpdateLeague(
      ...
      return localVarFp
        .partialUpdateLeague(id, league, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    partialUpdatePlayer(
      ...
      return localVarFp
        .partialUpdatePlayer(id, player, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    partialUpdateSeason(
      ...
      return localVarFp
        .partialUpdateSeason(id, season, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    partialUpdateTeam(
      ...
      return localVarFp
        .partialUpdateTeam(id, team, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateLeague(
      ...
      return localVarFp
        .updateLeague(id, league, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updatePlayer(
      ...
      return localVarFp
        .updatePlayer(id, player, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateSeason(
      ...
      return localVarFp
        .updateSeason(id, season, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class RestApi extends BaseAPI implements RestApiInterface {
  ...
  public createLeague(league?: League, options?: any) {
    return RestApiFp(this.configuration)
      .createLeague(league, options)
      .then((request) => request(this.axios, this.basePath));
  }
